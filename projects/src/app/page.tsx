  ...
  return (
    <>
      ...
      >
        ...
        <Link
          href="/video-demo"
          className="group mt-8 flex items-center justify-between rounded-lg border border-wj-border/70 bg-wj-surface p-5 transition-all duration-300 hover:border-wj-cinnabar/45 hover:shadow-[0_4px_8px_-2px_rgba(30,27,22,0.08),0_16px_40px_-16px_rgba(30,27,22,0.22)]"
        >
